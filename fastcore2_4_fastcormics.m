function A = fastcore2_4_fastcormics( C, model, epsilon, t) 
%
...
global fstN fstI fstIfVal testJ testP testSupp;
fstN = N;
fstI = I;
...
P = setdiff( N, C);
P = setdiff( P, t);
Supp = findSparseMode2_4_rFASTCORMICS( J, P, singleton, model, epsilon, t);
